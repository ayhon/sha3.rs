...
/- [algos::{algos::StateArray}#5::copy_to]: loop 0:
   Source: 'src/algos.rs', lines 1:0-110:9 -/
def StateArray.copy_to_loop
  ...
  then
    ...
    then
      ...
      let a1 ← (↑(core.num.U64.to_le_bytes i7) : Result (Array U8 8#usize))
      let s2 ←
      ...
      StateArray.copy_to_loop self dst1 i2
    else
      do
      let s1 ← (↑(Array.to_slice a) : Result (Slice U64))
      let i5 := Slice.len s1
      if i < i5
      then
        do
        let i6 ← 8#usize * i
        let i7 := Slice.len dst
        if i6 < i7
        then
          do
          let i8 := Slice.len dst
          let nb_left ← i8 - i6
          let (s2, index_mut_back) ←
            core.slice.index.Slice.index_mut
              (core.slice.index.SliceIndexRangeFromUsizeSlice U8) dst
              { start := i6 }
          let i9 ← Array.index_usize self i
          let a1 ←
            (↑(core.num.U64.to_le_bytes i9) : Result (Array U8 8#usize))
          let s3 ←
            core.array.Array.index (core.ops.index.IndexSliceInst
      ...
      then
        ...
        let (s2, index_mut_back) ←
          core.slice.index.Slice.index_mut
            (core.slice.index.SliceIndexRangeFromUsizeSlice U8) dst
            { start := i3 }
        let i6 ← Array.index_usize self i
        let a1 ←
          (↑(core.num.U64.to_le_bytes i6) : Result (Array U8 8#usize))
        let s3 ←
          core.array.Array.index (core.ops.index.IndexSliceInst
            (core.slice.index.SliceIndexRangeUsizeSliceInst U8)) a1
            { start := 0#usize, end_ := nb_left }
...
/- [algos::{algos::StateArray}#5::copy_to]:
   Source: 'src/algos.rs', lines 105:4-124:5 -/
@[reducible]
...
/- [algos::theta::d]:
   Source: 'src/algos.rs', lines 141:4-145:5 -/
...
/- [algos::theta::inner::inner]:
   Source: 'src/algos.rs', lines 152:26-154:17 -/
...
/- [algos::theta::inner]: loop 0:
   Source: 'src/algos.rs', lines 151:12-156:13 -/
...
/- [algos::theta::inner]:
   Source: 'src/algos.rs', lines 149:18-157:9 -/
@[reducible]
def theta.inner
...
/- [algos::theta]: loop 0:
   Source: 'src/algos.rs', lines 148:4-159:5 -/
def theta_loop
...
/- [algos::theta]:
   Source: 'src/algos.rs', lines 137:0-161:1 -/
...
/- [algos::RHO_OFFSETS]
   Source: 'src/algos.rs', lines 163:0-169:2 -/
@[global_simps]
def RHO_OFFSETS_body : Result (Array (Array U32 5#usize) 5#usize) :=
  ok
    (Array.make 5#usize [
...
def RHO_OFFSETS : Array (Array U32 5#usize) 5#usize :=
  eval_global RHO_OFFSETS_body

/- [algos::rho]: loop 0:
   Source: 'src/algos.rs', lines 175:4-179:5 -/
def rho_loop
  ...
  then
    do
    let i ← IndexalgosStateArrayPairUsizeUsizeU64.index a (x, y)
    let a2 ← Array.index_usize RHO_OFFSETS x
    let i1 ← Array.index_usize a2 y
...
/- [algos::pi::inner]:
   Source: 'src/algos.rs', lines 187:18-195:9 -/
@[reducible]
def pi.inner
  (res : StateArray) (a : StateArray) (x : Usize) : Result StateArray :=
...
/- [algos::pi]: loop 0:
   Source: 'src/algos.rs', lines 186:4-197:5 -/
def pi_loop
...
/- [algos::pi]:
   Source: 'src/algos.rs', lines 183:0-199:1 -/
@[reducible] def pi (a : StateArray) : Result StateArray :=
               pi_loop a a 0#usize

/- [algos::chi::inner]: loop 0:
   Source: 'src/algos.rs', lines 207:12-212:13 -/
def chi.inner_loop
  (res : StateArray) (a : StateArray) (x : Usize) (y : Usize) :
  Result StateArray
  :=
...
/- [algos::chi::inner]:
   Source: 'src/algos.rs', lines 205:18-213:9 -/
@[reducible]
def chi.inner
  (res : StateArray) (a : StateArray) (x : Usize) : Result StateArray :=
...
/- [algos::chi]: loop 0:
   Source: 'src/algos.rs', lines 204:4-215:5 -/
def chi_loop
  (a : StateArray) (a1 : StateArray) (x : Usize) : Result StateArray :=
  if x < 5#usize
  then do
...
/- [algos::chi]:
   Source: 'src/algos.rs', lines 201:0-217:1 -/
@[reducible]
def chi (a : StateArray) : Result StateArray :=
  chi_loop a a 0#usize

/- [algos::IOTA_RC]
   Source: 'src/algos.rs', lines 219:0-219:508 -/
@[global_simps]
...
/- [algos::iota]:
   Source: 'src/algos.rs', lines 221:0-225:1 -/
...
/- [algos::round]:
   Source: 'src/algos.rs', lines 227:0-234:1 -/
...
/- [algos::keccak_p]: loop 0:
   Source: 'src/algos.rs', lines 238:4-241:5 -/
...
/- [algos::sponge_absorb_initial]:
   Source: 'src/algos.rs', lines 245:0-254:1 -/
...
/- [algos::sponge_absorb_final]:
   Source: 'src/algos.rs', lines 257:0-270:1 -/
...
/- [algos::sponge_absorb]:
   Source: 'src/algos.rs', lines 273:0-278:1 -/
def sponge_absorb
...
/- [algos::sponge_squeeze]: loop 0:
   Source: 'src/algos.rs', lines 285:4-294:5 -/
...
/- [algos::sponge_squeeze]:
   Source: 'src/algos.rs', lines 281:0-295:1 -/
def sponge_squeeze
...
/- [algos::sponge]:
   Source: 'src/algos.rs', lines 298:0-302:1 -/
def sponge
...
/- [algos::sha3_256]:
   Source: 'src/algos.rs', lines 306:0-306:123 -/
...
/- [algos::sha3_384]:
   Source: 'src/algos.rs', lines 307:0-307:123 -/
...
/- [algos::sha3_512]:
   Source: 'src/algos.rs', lines 308:0-308:122 -/
